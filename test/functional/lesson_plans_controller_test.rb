...
class LessonPlansControllerTest < ActionController::TestCase
  ...
  test "should create lesson_plan" do
    assert_difference('LessonPlan.count') do
      post :create, lesson_plan: { content: @lesson_plan.content, difficulty: @lesson_plan.difficulty, grade: @lesson_plan.grade, length: @lesson_plan.length, subject: @lesson_plan.subject, tags: @lesson_plan.tags }
    end
  ...
  test "should update lesson_plan" do
    put :update, id: @lesson_plan, lesson_plan: { content: @lesson_plan.content, difficulty: @lesson_plan.difficulty, grade: @lesson_plan.grade, length: @lesson_plan.length, subject: @lesson_plan.subject, tags: @lesson_plan.tags }
    assert_redirected_to lesson_plan_path(assigns(:lesson_plan))
  end
